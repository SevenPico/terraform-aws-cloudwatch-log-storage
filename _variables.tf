...
variable "enable_s3_archive" {
  type        = bool
  default     = false
  description = "If set to true Lambda function automates CloudWatch Logs management. It sets log retention policies to a specified number of days, removes non-empty log streams, and provides a dry-run option for simulation"
}
...
variable "s3_archive_filter_pattern" {
  default = ""
}